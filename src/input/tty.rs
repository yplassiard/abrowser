//! TTY setup and teardown for raw terminal mode.
...
// Terminal sequences: alt screen, mouse tracking, cursor visibility
...
impl TTY {
    ...
    fn enter_alt_screen() -> io::Result<()> {
        ...
        // Query terminal capabilities for accessibility mode detection
